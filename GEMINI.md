...
- 主な機能: You can lock down channel reordering on multiple Discord servers with
  just one application running. / If you want to sort intentionally, you can
  temporarily unlock. / Can create and delete channels even when locked
